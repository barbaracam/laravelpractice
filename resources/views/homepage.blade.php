{{-- come from the layout blade, the info goes between the tags what is cll the slot --}}
<x-layout>
        ...
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/register" method="POST" id="registration-form">
            ...
            <div class="form-group">
              ...
              {{-- maintain the old data, if the form it is not completly validate, you can fix the mixtake and resend the form --}}
            ...
            {{-- add underscore confirmation  --}}
              @error('password_confirmation')
                <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
              @enderror
            </div>

            <button type="submit" class="py-3 mt-4 btn btn-lg btn-info btn-block">Sign up for OurApp</button>
          </form>
        </div>
      </div>
    </div>
